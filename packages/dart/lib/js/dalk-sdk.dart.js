...
(function dartProgram() {
    ...
    var C = {},
        H = {
            ...
            Primitives__genericApplyFunction2: function ($function, positionalArguments, namedArguments) {
                var $arguments, argumentCount, requiredParameterCount, defaultValuesClosure, t1, defaultValues,
                    interceptor, jsFunction, keys, _i, used, t2;
            ...
            unwrapException: function (ex) {
                var message, number, ieErrorCode, nsme, notClosure, nullCall, nullLiteralCall, undefCall,
                    undefLiteralCall, nullProperty, undefProperty, undefLiteralProperty, match, t2, _null = null,
            ...
            _functionRtiToString: function (rti, genericContext) {
                var boundsRti, outerContextLength, offset, i, i0, typeParameters, typeSep, t1, t2, boundRti,
                    returnTypeText, $arguments, argumentsText, sep, _i, argument, optionalArguments, namedArguments, t3,
                    _s2_ = ", ";
                if ("bounds" in rti) {
            ...
            _isSubtype: function (s, sEnv, t, tEnv) {
                var t1, typeOfS, tTypeArgument, futureSubstitution, futureArguments, t2, typeOfT, typeOfTString,
                    substitution, _null = null;
                if (s === t)
                    return true;
                if (t == null || t === -1 || t.name === "Object" || t === -2)
                    return true;
            ...
            _isFunctionSubtype: function (s, sEnv, t, tEnv) {
                var sBounds, tBounds, sParameterTypes, tParameterTypes, sOptionalParameterTypes,
                    tOptionalParameterTypes, sParametersLen, tParametersLen, sOptionalParametersLen,
                    tOptionalParametersLen, pos, tPos, sPos, sNamedParameters, tNamedParameters;
                if (!('func' in s))
                    return false;
                if ("bounds" in s) {
                    if (!("bounds" in t))
            ...
            JsLinkedHashMap: function JsLinkedHashMap(t0) {
                ...
                _._last = _.__js_helper$_first = _._rest = _._nums = _._strings = null;
                _._modifications = 0;
                _.$ti = t0;
            },
        ...
        J = {
            ...
            getNativeInterceptor: function (object) {
                ...
                if (typeof $constructor == "function") {
                    Object.defineProperty($constructor, $.$get$JS_INTEROP_INTERCEPTOR_TAG(), {
        ...
        P = {
            ...
            _AsyncRun__scheduleImmediateJsOverride: function (callback) {
                self.scheduleImmediate(H.convertDartClosureToJS(new P._AsyncRun__scheduleImmediateJsOverride_internalCallback(H.functionTypeCheck(callback, {
                    func: 1,
                    ret: -1
                })), 0));
            },
            _AsyncRun__scheduleImmediateWithSetImmediate: function (callback) {
                self.setImmediate(H.convertDartClosureToJS(new P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback(H.functionTypeCheck(callback, {
                    func: 1,
                    ret: -1
                })), 0));
            },
            ...
            _Future__propagateToListeners: function (source, listeners) {
                var _box_0, hasError, asyncError, listeners0, sourceResult, t2, t3, zone, t4, oldZone, current, result,
                    _null = null, _box_1 = {},
            ...
            scheduleMicrotask: function (callback) {
                ...
                P._rootScheduleMicrotask(_null, _null, currentZone, H.functionTypeCheck(currentZone.bindCallbackGuarded$1(callback), {
                    func: 1,
                    ret: -1
                }));
            },
            ...
            _ForwardingStreamSubscription: function _ForwardingStreamSubscription(t0, t1, t2, t3) {
                var _ = this;
                _._async$_stream = t0;
                _._onDone = _._onError = _._onData = _._async$_subscription = null;
                _._zone = t1;
                _._state = t2;
                _._pending = _._cancelFuture = null;
                _.$ti = t3;
            ...
            jsonDecode: function (source, reviver) {
                return C.C_JsonCodec.decode$2$reviver(H.stringTypeCheck(source), H.functionTypeCheck(reviver, {
                    func: 1,
                    ret: P.Object,
                    args: [P.Object, P.Object]
                }));
            },
            ...
            DateTime_parse: function (formattedString) {
                var t1, t2, years, month, day, hour, minute, second, milliAndMicroseconds, t3, t4, t5, sign,
                    hourDifference, minuteDifference, isUtc, value, _null = null,
            ...
            Uri_parse: function (uri) {
                var delta, t1, indices, schemeEnd, hostStart, portStart, pathStart, queryStart, fragmentStart, isSimple,
                    scheme, t2, schemeAuth, queryStart0, pathStart0, _null = null,
                    end = uri.length;
                if (end >= 5) {
            ...
            Uri_parseIPv6Address: function (host, start, end) {
                var parts, i, partStart, wildcardSeen, seenDot, char, atEnd, t1, last, bytes, t2, wildCardLength, index,
                    value, j, t3,
            ...
            _Uri__makePath: function (path, start, end, pathSegments, scheme, hasAuthority) {
                ...
                if (t1)
                    ...
                    result = new H.MappedListIterable(pathSegments, H.functionTypeCheck(new P._Uri__makePath_closure(), {
                        func: 1,
                        ret: t1,
                        args: [t2]
                    }), [t2, t1]).join$1(0, "/");
        ...
        U = {
            ...
            Client$withoutJson: function (channel) {
                var t1 = new U.Client(new V.ChannelManager("Client", channel, new P._SyncCompleter(new P._Future($.Zone__current, [null]), [null])), new H.JsLinkedHashMap([P.int, U._Request]));
            ...
            Chain_Chain$parse: function (chain) {
                ...
                if (J.getInterceptor$asx(chain).contains$1(chain, _s26_)) {
                    ...
                    return new U.Chain(P.List_List$unmodifiable(new H.MappedListIterable(t1, H.functionTypeCheck(new U.Chain_Chain$parse_closure(), {
                        func: 1,
                        ret: t2,
                        args: [t3]
                    }), [t3, t2]), t2));
                ...
                t2 = Y.Trace;
                t3 = H.getTypeArgumentByIndex(t1, 0);
                return new U.Chain(P.List_List$unmodifiable(new H.MappedListIterable(t1, H.functionTypeCheck(new U.Chain_Chain$parse_closure0(), {
                    func: 1,
                    ret: t2,
                    args: [t3]
                }), [t3, t2]), t2));
        ...
        G = {
            main: function () {
                var users, t2, t1 = {};
                t1.sdk = null;
                users = P.LinkedHashMap_LinkedHashMap$_empty(P.String, G.User);
                t1.conversations = H.setRuntimeTypeInfo([], [G.Conversation]);
                window.DalkSdkCreate = P.allowInterop(new G.main_closure(t1, users), {
                    func: 1,
                    ret: G.DalkSdk,
                    args: [, ,]
                });
                window.dalkConnect = P.allowInterop(new G.main_closure0(t1), {func: 1, ret: [G.Promise, -2]});
                window.dalkGetConversations = P.allowInterop(new G.main_closure1(t1), {func: 1, ret: [G.Promise, -2]});
                window.dalkGetConversation = P.allowInterop(new G.main_closure2(t1), {
                    func: 1,
                    ret: [G.Promise, -2],
                    args: [P.String]
                });
                window.dalkCreateOneToOneConversation = P.allowInterop(new G.main_closure3(t1), {
                    func: 1,
                    ret: [G.Promise, -2],
                    args: [G.User, P.String]
                });
                window.dalkCreateGroupConversation = P.allowInterop(new G.main_closure4(t1), {
                    func: 1,
                    ret: [G.Promise, -2],
                    args: [[P.List, G.User], P.String, P.String, P.String]
                });
                window.dalkDisconnect = P.allowInterop(new G.main_closure5(t1), {func: 1, ret: [G.Promise, -2]});
                t2 = {func: 1, ret: [G.Promise, -2], args: [P.String, P.String]};
                window.dalkSendMessage = P.allowInterop(new G.main_closure6(t1), t2);
                window.dalkSetMessageAsSeen = P.allowInterop(new G.main_closure7(t1), t2);
                window.dalkLoadMessages = P.allowInterop(new G.main_closure8(t1), t2);
                window.dalkSetOptions = P.allowInterop(new G.main_closure9(t1), {
                    func: 1,
                    ret: [G.Promise, -2],
                    args: [P.String, P.String, P.String]
                });
                window.DalkUser = P.allowInterop(new G.main_closure10(users), {func: 1, ret: G.User, args: [, , ,]});
            },
            ...
            _Message_fromBackend: function (data) {
                var userStatus, t2, t3, t4, t5,
                    t1 = H.listTypeCast(data.$index(0, "stateDetails"));
                ...
                t4 = P.DateTime_parse(H.stringTypeCheck(data.$index(0, "timestamp")));
                t5 = data.$index(0, "state");
                t5 = H.intTypeCheck(t5 == null ? 0 : t5);
                if (t5 < 0 || t5 >= 4)
                    return H.ioore(C.List_AYZ, t5);
                return new G._$__Message(t1, t2, t3, t4, C.List_AYZ[t5], userStatus);
            },
            ...
            MessageStatus: function MessageStatus(t0, t1) {
                this.index = t0;
                this._sdk_base$_name = t1;
            },
            ...
            _ConversationImpl: function _ConversationImpl(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
                var _ = this;
                _.id = t0;
                _._subject = t1;
                _._avatar = t2;
            ...
            _ConversationImpl__incomingMessage_closure: function _ConversationImpl__incomingMessage_closure(t0) {
                this.message = t0;
            },
            _ConversationImpl__incomingMessage_closure0: function _ConversationImpl__incomingMessage_closure0() {
            },
            ...
            DalkSdk__connectAndReconnect_closure: function DalkSdk__connectAndReconnect_closure() {
            },
            DalkSdk_connect_closure: function DalkSdk_connect_closure(t0) {
                this.$this = t0;
            },
            DalkSdk_connect_closure0: function DalkSdk_connect_closure0(t0) {
                this.$this = t0;
            },
            DalkSdk_connect_closure1: function DalkSdk_connect_closure1(t0) {
                this.$this = t0;
            },
            DalkSdk_connect_closure2: function DalkSdk_connect_closure2(t0) {
                this.$this = t0;
            },
        ...
        K = {
            ...
            GuaranteeChannel: function GuaranteeChannel(t0) {
                var _ = this;
                _._subscription = _._streamController = _._guarantee_channel$_sink = null;
        ...
        V = {
            ChannelManager: function ChannelManager(t0, t1, t2) {
                var _ = this;
        ...
        S = {
            Parameters: function Parameters(t0, t1) {
                this.method = t0;
        ...
        R = {
            Server: function Server(t0, t1, t2, t3) {
                var _ = this;
        ...
        B = {
            _RespondToFormatExceptionsTransformer: function _RespondToFormatExceptionsTransformer() {
            },
        ...
        Y = {
            ...
            Trace__parseVM: function (trace) {
                ...
                t2 = A.Frame;
                t3 = H.getTypeArgumentByIndex(t1, 0);
                $frames = new H.MappedListIterable(t1, H.functionTypeCheck(new Y.Trace__parseVM_closure(), {
                    func: 1,
                    ret: t2,
                    args: [t3]
                }), [t3, t2]).toList$0(0);
            ...
            Trace$parseV8: function (trace) {
                ...
                t1 = t1.super$Iterable$skipWhile(0, H.functionTypeCheck(new Y.Trace$parseV8_closure(), {
                    func: 1,
                    ret: P.bool,
                    args: [H.getTypeArgumentByIndex(t1, 0)]
                }));
                t2 = A.Frame;
                t3 = H.getTypeArgumentByIndex(t1, 0);
                return new Y.Trace(P.List_List$unmodifiable(H.MappedIterable_MappedIterable(t1, H.functionTypeCheck(new Y.Trace$parseV8_closure0(), {
                    func: 1,
                    ret: t2,
                    args: [t3]
                }), t3, t2), t2), new P._StringStackTrace(trace));
            },
            Trace$parseJSCore: function (trace) {
                var t1 = H.setRuntimeTypeInfo(trace.split("\n"), [P.String]),
                    t2 = H.getTypeArgumentByIndex(t1, 0),
                    t3 = A.Frame;
                return new Y.Trace(P.List_List$unmodifiable(new H.MappedIterable(new H.WhereIterable(t1, H.functionTypeCheck(new Y.Trace$parseJSCore_closure(), {
                    func: 1,
                    ret: P.bool,
                    args: [t2]
                }), [t2]), H.functionTypeCheck(new Y.Trace$parseJSCore_closure0(), {
                    func: 1,
                    ret: t3,
                    args: [t2]
                }), [t2, t3]), t3), new P._StringStackTrace(trace));
            },
            Trace$parseFirefox: function (trace) {
                var t1 = H.setRuntimeTypeInfo(C.JSString_methods.trim$0(trace).split("\n"), [P.String]),
                    t2 = H.getTypeArgumentByIndex(t1, 0),
                    t3 = A.Frame;
                return new Y.Trace(P.List_List$unmodifiable(new H.MappedIterable(new H.WhereIterable(t1, H.functionTypeCheck(new Y.Trace$parseFirefox_closure(), {
                    func: 1,
                    ret: P.bool,
                    args: [t2]
                }), [t2]), H.functionTypeCheck(new Y.Trace$parseFirefox_closure0(), {
                    func: 1,
                    ret: t3,
                    args: [t2]
                }), [t2, t3]), t3), new P._StringStackTrace(trace));
            ...
            Trace$parseFriendly: function (trace) {
                ...
                if (trace.length === 0)
                    ...
                    t3 = new H.MappedIterable(new H.WhereIterable(t2, H.functionTypeCheck(new Y.Trace$parseFriendly_closure(), {
                        func: 1,
                        ret: P.bool,
                        args: [t3]
                    }), [t3]), H.functionTypeCheck(new Y.Trace$parseFriendly_closure0(), {
                        func: 1,
                        ret: t1,
                        args: [t3]
                    }), [t3, t1]);
        ...
        F = {
            ...
            CloseGuaranteeChannel$: function (innerStream, innerSink, $T) {
                ...
                t1.set$_stream(new F._CloseGuaranteeStream(innerStream, t1, [$T]));
                return t1;
            },
            CloseGuaranteeChannel: function CloseGuaranteeChannel(t0) {
                var _ = this;
                _._close_guarantee_channel$_subscription = _._sink = _._stream = null;
        ...
        M = {
            ...
            _validateArgList: function (method, args) {
                ...
                for (numArgs = args.length, i = 1; i < numArgs; ++i) {
                    ...
                    t3 = t1 + new H.MappedListIterable(t2, H.functionTypeCheck(new M._validateArgList_closure(), {
                        func: 1,
                        ret: t3,
                        args: [t4]
                    }), [t4, t3]).join$1(0, ", ");
    ...
    var holders = [C, H, J, P, W, O, X, U, G, K, V, E, S, R, B, Y, L, F, M, A, N, D];
    ...
    H.CastStream.prototype = {
        listen$4$cancelOnError$onDone$onError: function (onData, cancelOnError, onDone, onError) {
            ...
            t1 = this._source.listen$3$cancelOnError$onDone(null, cancelOnError, H.functionTypeCheck(onDone, {
                func: 1,
                ret: -1
            }));
    ...
    H.CastStreamSubscription.prototype = {
        ...
        onData$1: function (handleData) {
            ...
            this.set$_handleData(handleData == null ? null : H.functionTypeCheck(handleData, {
                func: 1,
                ret: null,
                args: [t1]
            }));
        ...
        onError$1: function (_, handleError) {
            ...
            if (handleError == null)
                ...
                if (H.functionTypeTest(handleError, {func: 1, args: [P.Null, P.Null]}))
                    _this._handleError = _this.__internal$_zone.registerBinaryCallback$3$1(H.functionTypeCheck(handleError, {
                        func: 1,
                        args: [P.Object, P.StackTrace]
                    }), null, t1, P.StackTrace);
                else
                    _this._handleError = H.functionTypeCheck(H.functionTypeCheck(handleError, {
                        func: 1,
                        args: [P.Object]
                    }), {func: 1, ret: null, args: [t1]});
            }
        },
        __internal$_onData$1: function (data) {
            ...
            try {
                ...
                if (t1 == null)
                    ...
                    if (t2)
                        t3.runBinaryGuarded$2$3(H.functionTypeCheck(t4, {
                            func: 1,
                            ret: -1,
                            args: [, P.StackTrace]
                        }), error, stack, _null, P.StackTrace);
                    else
        ...
        set$_handleData: function (_handleData) {
            this._handleData = H.functionTypeCheck(_handleData, {
                func: 1,
                ret: -1,
                args: [H.getTypeArgumentByIndex(this, 1)]
            });
        },
    ...
    H._EfficientLengthCastIterable.prototype = {
        $isEfficientLengthIterable: 1,
    ...
    H.ListIterable.prototype = {
        ...
        fold$1$2: function (_, initialValue, combine, $T) {
            ...
            H.functionTypeCheck(combine, {
                func: 1,
                ret: $T,
                args: [$T, H.getRuntimeTypeArgument(_this, "ListIterable", 0)]
            });
            $length = _this.get$length(_this);
    ...
    H.JsLinkedHashMap.prototype = {
        ...
        clear$0: function (_) {
            ...
            if (_this.__js_helper$_length > 0) {
                _this._strings = _this._nums = _this._rest = _this.__js_helper$_first = _this._last = null;
        ...
        forEach$1: function (_, action) {
            ...
            H.functionTypeCheck(action, {
                func: 1,
                ret: -1,
                args: [H.getTypeArgumentByIndex(_this, 0), H.getTypeArgumentByIndex(_this, 1)]
            });
    ...
    P._FutureListener.prototype = {
        matchesErrorTest$1: function (asyncError) {
            if ((this.state & 15) !== 6)
                return true;
            return this.result._zone.runUnary$2$2(H.functionTypeCheck(this.callback, {
                func: 1,
                ret: P.bool,
                args: [P.Object]
            }), asyncError.error, P.bool, P.Object);
        },
        handleError$1: function (asyncError) {
            ...
            if (H.functionTypeTest(errorCallback, {func: 1, args: [P.Object, P.StackTrace]}))
                ...
                return H.futureOrCheck(t3.runUnary$2$2(H.functionTypeCheck(errorCallback, {
                    func: 1,
                    args: [P.Object]
                }), asyncError.error, null, t1), t2);
        }
    };
    P._Future.prototype = {
        ...
        _addListener$1: function (listener) {
            ...
            if (t1 <= 1) {
                ...
                P._rootScheduleMicrotask(null, null, _this._zone, H.functionTypeCheck(new P._Future__addListener_closure(_this, listener), {
                    func: 1,
                    ret: -1
                }));
            }
        ...
        _prependListeners$1: function (listeners) {
            ...
            if (t1 <= 1) {
                ...
                P._rootScheduleMicrotask(null, null, _this._zone, H.functionTypeCheck(new P._Future__prependListeners_closure(_box_0, _this), {
                    func: 1,
                    ret: -1
                }));
            }
        ...
        _asyncComplete$1: function (value) {
            ...
            _this._state = 1;
            P._rootScheduleMicrotask(null, null, _this._zone, H.functionTypeCheck(new P._Future__asyncComplete_closure(_this, value), {
                func: 1,
                ret: -1
            }));
        },
        _chainFuture$1: function (value) {
            ...
            if (H.checkSubtype(value, "$is_Future", t1, null)) {
                if (value._state === 8) {
                    _this._state = 1;
                    P._rootScheduleMicrotask(null, null, _this._zone, H.functionTypeCheck(new P._Future__chainFuture_closure(_this, value), {
                        func: 1,
                        ret: -1
                    }));
                }
        ...
        _asyncCompleteError$2: function (error, stackTrace) {
            H.interceptedTypeCheck(stackTrace, "$isStackTrace");
            this._state = 1;
            P._rootScheduleMicrotask(null, null, this._zone, H.functionTypeCheck(new P._Future__asyncCompleteError_closure(this, error, stackTrace), {
                func: 1,
                ret: -1
            }));
        },
    ...
    P._Future__propagateToListeners_handleValueCallback.prototype = {
        call$0: function () {
            ...
            try {
                ...
                _this._box_0.listenerValueOrError = t1.result._zone.runUnary$2$2(H.functionTypeCheck(t1.callback, {
                    func: 1,
                    ret: {futureOr: 1, type: t4},
                    args: [t2]
                }), t3, {futureOr: 1, type: t4}, t2);
            } catch (exception) {
                e = H.unwrapException(exception);
                s = H.getTraceFromException(exception);
                t1 = _this._box_0;
    ...
    P.StreamView.prototype = {
        listen$4$cancelOnError$onDone$onError: function (onData, cancelOnError, onDone, onError) {
            return this._async$_stream.listen$4$cancelOnError$onDone$onError(H.functionTypeCheck(onData, {
                func: 1,
                ret: -1,
                args: [H.getTypeArgumentByIndex(this, 0)]
            }), cancelOnError, H.functionTypeCheck(onDone, {func: 1, ret: -1}), onError);
        },
        listen$3$cancelOnError$onDone: function (onData, cancelOnError, onDone) {
            return this.listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, null);
        },
    ...
    P._BufferingStreamSubscription.prototype = {
        ...
        set$_onData: function (_onData) {
            this._onData = H.functionTypeCheck(_onData, {
                func: 1,
                ret: -1,
                args: [H.getRuntimeTypeArgument(this, "_BufferingStreamSubscription", 0)]
            });
        },
    ...
    P._StreamImpl.prototype = {
        listen$4$cancelOnError$onDone$onError: function (onData, cancelOnError, onDone, onError) {
            ...
            H.functionTypeCheck(onDone, {func: 1, ret: -1});
            return this._controller._subscribe$4(H.functionTypeCheck(onData, {
                func: 1,
                ret: -1,
                args: [H.getTypeArgumentByIndex(this, 0)]
            }), onError, onDone, true === cancelOnError);
        },
        listen$3$cancelOnError$onDone: function (onData, cancelOnError, onDone) {
            return this.listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, null);
        },
    ...
    P._DoneStreamSubscription.prototype = {
        _schedule$0: function () {
            ...
            if ((_this._state & 2) !== 0)
                return;
            P._rootScheduleMicrotask(null, null, _this._zone, H.functionTypeCheck(_this.get$_sendDone(), {
                func: 1,
                ret: -1
            }));
    ...
    P._ForwardingStream.prototype = {
        listen$4$cancelOnError$onDone$onError: function (onData, cancelOnError, onDone, onError) {
            ...
            t3.set$_async$_subscription(_this._async$_source.listen$3$onDone$onError(t3.get$_async$_handleData(), t3.get$_handleDone(), t3.get$_async$_handleError()));
            return t3;
        },
        listen$3$cancelOnError$onDone: function (onData, cancelOnError, onDone) {
            return this.listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, null);
    ...
    P._ForwardingStreamSubscription.prototype = {
        ...
        _async$_handleData$1: function (data) {
            this._async$_stream._async$_handleData$2(H.assertSubtypeOfRuntimeType(data, H.getTypeArgumentByIndex(this, 0)), this);
        },
        _async$_handleError$2: function (error, stackTrace) {
            this._async$_stream._async$_handleError$3(error, H.interceptedTypeCheck(stackTrace, "$isStackTrace"), this);
        },
        ...
        set$_async$_subscription: function (_subscription) {
            this._async$_subscription = H.assertSubtype(_subscription, "$isStreamSubscription", [H.getTypeArgumentByIndex(this, 0)], "$asStreamSubscription");
        },
        $asStreamSubscription: function ($S, $T) {
            return [$T];
        },
    ...
    P._RootZone.prototype = {
        ...
        bindUnaryCallbackGuarded$1$1: function (f, $T) {
            return new P._RootZone_bindUnaryCallbackGuarded_closure(this, H.functionTypeCheck(f, {
                func: 1,
                ret: -1,
                args: [$T]
            }), $T);
    ...
    P.ListMixin.prototype = {
        ...
        forEach$1: function (receiver, action) {
            ...
            H.functionTypeCheck(action, {
                func: 1,
                ret: -1,
                args: [H.getRuntimeTypeArgumentIntercepted(_this, receiver, "ListMixin", 0)]
            });
    ...
    P.MapMixin.prototype = {
        forEach$1: function (_, action) {
            ...
            H.functionTypeCheck(action, {
                func: 1,
                ret: -1,
                args: [H.getRuntimeTypeArgument(_this, "MapMixin", 0), H.getRuntimeTypeArgument(_this, "MapMixin", 1)]
            });
    ...
    P.MapView.prototype = {
        ...
        forEach$1: function (_, action) {
            this._collection$_map.forEach$1(0, H.functionTypeCheck(action, {
                func: 1,
                ret: -1,
                args: [H.getTypeArgumentByIndex(this, 0), H.getTypeArgumentByIndex(this, 1)]
            }));
        },
        get$isEmpty: function (_) {
            var t1 = this._collection$_map;
    ...
    P.Base64Codec.prototype = {
        normalize$3: function (source, start, end) {
            var inverseAlphabet, i, sliceStart, buffer, firstPadding, firstPaddingSourceIndex, paddingCount, i0, char,
                i1, digit1, digit2, char0, value, t1, t2, endLength, $length,
    ...
    P.Iterable.prototype = {
        ...
        map$1$1: function (_, f, $T) {
            ...
            return H.MappedIterable_MappedIterable(this, H.functionTypeCheck(f, {
                func: 1,
                ret: $T,
                args: [t1]
            }), t1, $T);
    ...
    P._Uri.prototype = {
        ...
        get$pathSegments: function () {
            ...
            if (pathToSplit === "")
                ...
                t3 = H.getTypeArgumentByIndex(t2, 0);
                result = P.List_List$unmodifiable(new H.MappedListIterable(t2, H.functionTypeCheck(P.core_Uri_decodeComponent$closure(), {
                    func: 1,
                    ret: null,
                    args: [t3]
                }), [t3, null]), t1);
    ...
    P._SimpleUri.prototype = {
        ...
        _simpleMerge$2: function (base, ref) {
            var t2, t3, isSimple, delta, newUri, t4, t5, refStart, baseStart, baseEnd, baseUri, baseStart0, backCount,
                refStart0, insert,
                t1 = ref._schemeEnd;
            if (t1 > 0)
                return ref;
    ...
    W.EventTarget.prototype = {
        ...
        _addEventListener$3: function (receiver, type, listener, options) {
            return receiver.addEventListener(type, H.convertDartClosureToJS(H.functionTypeCheck(listener, {
                func: 1,
                args: [W.Event]
            }), 1), false);
        },
        _removeEventListener$3: function (receiver, type, listener, options) {
            return receiver.removeEventListener(type, H.convertDartClosureToJS(H.functionTypeCheck(listener, {
                func: 1,
                args: [W.Event]
            }), 1), false);
        },
    ...
    W._EventStreamSubscription.prototype = {
        ...
        onData$1: function (handleData) {
            ...
            _this._unlisten$0();
            _this.set$_html0$_onData(W._wrapZone(H.functionTypeCheck(handleData, {
                func: 1,
                ret: -1,
                args: [W.Event]
            }), W.Event));
    ...
    X._HandlerSink.prototype = {
        add$1: function (_, $event) {
            ...
            H.functionTypeCheck(_this._transformer._handler_transformer$_handleData, {
                func: 1,
                ret: -1,
                args: [t1, [P.EventSink, H.getTypeArgumentByIndex(_this, 1)]]
            }).call$2($event, _this._safeCloseInner);
        },
        close$0: function (_) {
    ...
    G.Promise.prototype = {};
    G._Exports.prototype = {};
    G.main_closure.prototype = {
        call$2: function (projectId, user) {
            var t1, t2, t3, t4, t5;
            ...
            return this._box_0.sdk = new G.DalkSdk(projectId, user, new G.main__closure9(this.users), t2, P.LinkedHashMap_LinkedHashMap$_empty(t1, t3), t4, t5);
        },
        "call*": "call$2",
        $requiredArgCount: 2,
        $signature: 69
    };
    G.main__closure9.prototype = {
        call$1: function (userId) {
            return this.users.$index(0, H.stringTypeCheck(userId));
        },
        $signature: 74
    };
    G.main_closure0.prototype = {
        call$0: function () {
            var t1 = P.allowInterop(new G.main__closure8(this._box_0), {
                func: 1,
                ret: -1,
                args: [{func: 1, ret: -1, args: [P.bool]}, P.Function]
            });
    ...
    G.main__closure8.prototype = {
        call$2: function (resolve, reject) {
            ...
            this._box_0.sdk.connect$0().then$1$1(0, resolve, -1).catchError$1(reject);
        },
        "call*": "call$2",
        $requiredArgCount: 2,
        $signature: 32
    ...
    G.main_closure1.prototype = {
        call$0: function () {
            var t1 = P.allowInterop(new G.main__closure7(this._box_0), {
                func: 1,
                ret: -1,
                args: [{func: 1, ret: -1, args: [[P.List, ,]]}, P.Function]
            });
    ...
    G.main__closure7.prototype = {
        call$2: function (resolve, reject) {
            var t1;
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [[P.List, ,]]});
            H.interceptedTypeCheck(reject, "$isFunction");
            t1 = this._box_0;
            t1.sdk.getConversations$0().then$1$1(0, new G.main___closure8(t1, resolve), P.Null).catchError$1(reject);
        },
        "call*": "call$2",
        $requiredArgCount: 2,
        $signature: 34
    };
    G.main___closure8.prototype = {
    ...
    G.main_closure2.prototype = {
        call$1: function (convId) {
            var t1 = P.allowInterop(new G.main__closure6(this._box_0, H.stringTypeCheck(convId)), {
                func: 1,
                ret: P.Null,
                args: [{func: 1, ret: -1, args: [P.Null]}, P.Function]
            });
            return new self.Promise(t1, P.Null);
        },
        $signature: 36
    };
    G.main__closure6.prototype = {
        call$2: function (resolve, reject) {
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [P.Null]});
            H.interceptedTypeCheck(reject, "$isFunction");
            this._box_0.sdk.getConversation$1(this.convId).then$1$1(0, H.functionTypeCheck(resolve, {
                func: 1,
                ret: {futureOr: 1},
                args: [G.Conversation]
            }), null).catchError$1(reject);
        },
        "call*": "call$2",
        $requiredArgCount: 2,
        $signature: 17
    ...
    G.main_closure3.prototype = {
        call$2: function (user, conversationId) {
            var t1 = P.allowInterop(new G.main__closure5(this._box_0, H.interceptedTypeCheck(user, "$isUser"), H.stringTypeCheck(conversationId)), {
                func: 1,
                ret: P.Null,
                args: [{func: 1, ret: -1, args: [P.Null]}, P.Function]
            });
    ...
    G.main__closure5.prototype = {
        call$2: function (resolve, reject) {
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [P.Null]});
            H.interceptedTypeCheck(reject, "$isFunction");
            this._box_0.sdk.createOneToOneConversation$2$conversationId(this.user, this.conversationId).then$1$1(0, H.functionTypeCheck(resolve, {
                func: 1,
                ret: {futureOr: 1},
                args: [G.Conversation]
            }), null).catchError$1(reject);
    ...
    G.main_closure4.prototype = {
        call$4: function (users, conversationId, subject, avatar) {
            ...
            t1 = P.allowInterop(new G.main__closure4(this._box_0, users, conversationId, H.stringTypeCheck(avatar), subject), {
                func: 1,
                ret: P.Null,
                args: [{func: 1, ret: -1, args: [P.Null]}, P.Function]
            });
    ...
    G.main__closure4.prototype = {
        call$2: function (resolve, reject) {
            var _this = this;
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [P.Null]});
            H.interceptedTypeCheck(reject, "$isFunction");
            _this._box_0.sdk.createGroupConversation$4$avatar$conversationId$subject(_this.users, _this.avatar, _this.conversationId, _this.subject).then$1$1(0, H.functionTypeCheck(resolve, {
                func: 1,
                ret: {futureOr: 1},
                args: [G.Conversation]
            }), null).catchError$1(reject);
    ...
    G.main_closure5.prototype = {
        call$0: function () {
            var t1 = P.allowInterop(new G.main__closure3(this._box_0), {
                func: 1,
                ret: -1,
                args: [{func: 1, ret: -1, args: [-1]}, P.Function]
            });
    ...
    G.main__closure3.prototype = {
        call$2: function (resolve, reject) {
            var t1;
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [-1]});
            H.interceptedTypeCheck(reject, "$isFunction");
            t1 = this._box_0.sdk;
            t1._shouldReconnect = false;
            t1._peer.close$0(0).then$1$1(0, resolve, -1).catchError$1(reject);
        },
        "call*": "call$2",
        $requiredArgCount: 2,
        $signature: 8
    ...
    G.main_closure6.prototype = {
        call$2: function (conversationId, message) {
            var t1 = P.allowInterop(new G.main__closure2(this._box_0, H.stringTypeCheck(conversationId), H.stringTypeCheck(message)), {
                func: 1,
                ret: -1,
                args: [{func: 1, ret: -1, args: [-1]}, P.Function]
            });
    ...
    G.main__closure2.prototype = {
        call$2: function (resolve, reject) {
            var t1;
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [-1]});
            H.interceptedTypeCheck(reject, "$isFunction");
            t1 = J.firstWhere$2$orElse$ax(this._box_0.conversations, new G.main___closure6(this.conversationId), new G.main___closure7());
    ...
    G.main_closure7.prototype = {
        call$2: function (conversationId, messageId) {
            var t1 = P.allowInterop(new G.main__closure1(this._box_0, H.stringTypeCheck(conversationId), H.stringTypeCheck(messageId)), {
                func: 1,
                ret: -1,
                args: [{func: 1, ret: -1, args: [-1]}, P.Function]
            });
    ...
    G.main__closure1.prototype = {
        call$2: function (resolve, reject) {
            var t1;
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [-1]});
            H.interceptedTypeCheck(reject, "$isFunction");
            t1 = J.firstWhere$2$orElse$ax(this._box_0.conversations, new G.main___closure4(this.conversationId), new G.main___closure5());
    ...
    G.main___closure4.prototype = {
        call$1: function (conv) {
            return H.interceptedTypeCheck(conv, "$isConversation").id == this.conversationId;
        },
        $signature: 11
    };
    G.main___closure5.prototype = {
        call$0: function () {
            return;
        },
        $signature: 0
    };
    G.main_closure8.prototype = {
        call$2: function (conversationId, messageId) {
            var t1;
            H.stringTypeCheck(conversationId);
            H.stringTypeCheck(messageId);
            t1 = P.allowInterop(new G.main__closure0(this._box_0, conversationId), {
                func: 1,
                ret: -1,
                args: [{func: 1, ret: -1, args: [-1]}, P.Function]
            });
    ...
    G.main__closure0.prototype = {
        call$2: function (resolve, reject) {
            var conv, t1;
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [-1]});
            H.interceptedTypeCheck(reject, "$isFunction");
            conv = J.firstWhere$2$orElse$ax(this._box_0.conversations, new G.main___closure1(this.conversationId), new G.main___closure2());
            t1 = conv == null ? null : conv.loadMessages$0();
            t1 = t1 == null ? null : t1.then$1$1(0, new G.main___closure3(resolve, conv), -1);
            if (t1 != null)
                t1.catchError$1(reject);
        },
        "call*": "call$2",
    ...
    G.main___closure1.prototype = {
        call$1: function (conv) {
            return H.interceptedTypeCheck(conv, "$isConversation").id == this.conversationId;
        },
        $signature: 11
    };
    G.main___closure2.prototype = {
        call$0: function () {
            return;
        },
        $signature: 0
    };
    G.main___closure3.prototype = {
        call$1: function (_) {
            return this.resolve.call$1(this.conv.messages);
        },
        $signature: 44
    };
    G.main_closure9.prototype = {
        call$3: function (conversationId, subject, avatar) {
            var t1 = P.allowInterop(new G.main__closure(this._box_0, H.stringTypeCheck(conversationId), H.stringTypeCheck(subject), H.stringTypeCheck(avatar)), {
                func: 1,
                ret: -1,
                args: [{func: 1, ret: -1, args: [-1]}, P.Function]
            });
    ...
    G.main__closure.prototype = {
        call$2: function (resolve, reject) {
            ...
            H.functionTypeCheck(resolve, {func: 1, ret: -1, args: [-1]});
            H.interceptedTypeCheck(reject, "$isFunction");
            conv = J.firstWhere$2$orElse$ax(_this._box_0.conversations, new G.main___closure(_this.conversationId), new G.main___closure0());
    ...
    G.main___closure.prototype = {
        call$1: function (conv) {
            return H.interceptedTypeCheck(conv, "$isConversation").id == this.conversationId;
        },
        $signature: 11
    };
    G.main___closure0.prototype = {
        call$0: function () {
            return;
        },
        $signature: 0
    };
    G.main_closure10.prototype = {
    ...
    G._ConversationImpl.prototype = {
        ...
        _incomingMessage$body$_ConversationImpl: function (data) {
            var $async$goto = 0,
                ...
                $async$self = this, message, t1, existingIndex;
            var $async$_incomingMessage$1 = P._wrapJsFunctionForAsync(function ($async$errorCode, $async$result) {
                ...
                while (true)
                    switch ($async$goto) {
                        case 0:
                            // Function start
                            message = G._Message_fromBackend(data);
                            t1 = $async$self.messages;
                            existingIndex = C.JSArray_methods.indexWhere$1(t1, new G._ConversationImpl__incomingMessage_closure(message));
                            if (existingIndex === -1)
                                C.JSArray_methods.add$1(t1, message);
                            else
                                C.JSArray_methods.$indexSet(t1, existingIndex, message);
                            $async$self._messageEvent.add$1(0, message);
                            $async$goto = 2;
                            return P._asyncAwait($async$self._setMessageStatus$2(message.id, C.MessageStatus_1).catchError$1(new G._ConversationImpl__incomingMessage_closure0()), $async$_incomingMessage$1);
                        case 2:
        ...
        _setMessageStatus$body$_ConversationImpl: function (messageId, $status) {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(-1),
                $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, ex, stack, t1, t2,
                ...
                while (true)
                    switch ($async$goto) {
                        ...
                        case 2:
                            ...
                            $async$handler = 5;
                            t1 = $async$self._peer;
                            t2 = P.LinkedHashMap_LinkedHashMap$_literal(["id", messageId, "state", $status.index], P.String, P.Object);
                            $async$goto = 8;
                            return P._asyncAwait(t1._client.sendRequest$2("updateMessageState", t2), $async$_setMessageStatus$2);
                        case 8:
                            // returning from await.
                            $async$self._logger.log$4(C.Level_INFO_800, "updateMessageState " + messageId + " " + $status.toString$0(0), null, null);
                            $async$handler = 1;
                            // goto after finally
                            $async$goto = 7;
                            break;
        ...
        sendMessage$body$_ConversationImpl: function (message) {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(-1),
                $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, date, messageData,
                result, existingIndex, ex, stack, t1, t2, t3, t4, t5, exception, $async$exception;
        ...
        loadMessages$0: function () {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(-1),
                $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, result, messageList, ex,
                stack, t2, exception, t1, $async$exception;
        ...
        setOptions$body$_ConversationImpl: function (avatar, subject) {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(-1),
                $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, t1, ex, stack, t2, t3,
                exception, $async$exception;
                ...
                while (true)
                    switch ($async$goto) {
                        case 0:
                            ...
                            if ($async$self._peer._manager._doneCompleter.future._state !== 0)
                                throw H.wrapException(G.ConnectionClosedException$_());
                            if (J.get$length$asx($async$self.users) === 2)
        ...
        toString$0: function (_) {
            var _this = this;
            return "Conversation{id: " + H.S(_this.id) + ", subject: " + H.S(_this._subject) + ", avatar: " + H.S(_this._avatar) + ", users: " + H.S(_this.users) + ", admins: " + H.S(_this.admins) + ", messages: " + H.S(_this.messages) + "}";
        },
        $isConversation: 1
    };
    ...
    G.DalkSdk.prototype = {
        _connectAndReconnect$0: function () {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(-1),
                $async$self = this;
            var $async$_connectAndReconnect$0 = P._wrapJsFunctionForAsync(function ($async$errorCode, $async$result) {
                if ($async$errorCode === 1)
                    return P._asyncRethrow($async$result, $async$completer);
                while (true)
                    switch ($async$goto) {
                        case 0:
                            // Function start
                            $async$goto = 2;
                            return P._asyncAwait($async$self._peer.listen$0().catchError$1(new G.DalkSdk__connectAndReconnect_closure()), $async$_connectAndReconnect$0);
                        case 2:
                            // returning from await.
                            $async$goto = $async$self._shouldReconnect ? 3 : 4;
                            break;
                        case 3:
                            // then
                            $async$self._logger.log$4(C.Level_WARNING_900, "reconnect peer", null, null);
                            $async$goto = 5;
                            return P._asyncAwait($async$self.connect$0(), $async$_connectAndReconnect$0);
                        case 5:
                        // returning from await.
                        case 4:
                            // join
            ...
            return P._asyncStartSync($async$_connectAndReconnect$0, $async$completer);
        },
        _getUsersFromIds$1: function (ids) {
            return this._getUsersFromIds$body$DalkSdk(H.assertSubtype(ids, "$isList", [P.String], "$asList"));
        },
        _getUsersFromIds$body$DalkSdk: function (ids) {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter([P.List, G.User]),
                $async$returnValue, $async$self = this, t1, t2, t3, t4, users, $async$temp1, $async$temp2;
            var $async$_getUsersFromIds$1 = P._wrapJsFunctionForAsync(function ($async$errorCode, $async$result) {
                if ($async$errorCode === 1)
                    return P._asyncRethrow($async$result, $async$completer);
                while (true)
                    switch ($async$goto) {
                        case 0:
                            // Function start
                            users = H.setRuntimeTypeInfo([], [G.User]);
                            if (ids == null) {
                                $async$returnValue = users;
                                // goto return
                                $async$goto = 1;
                                break;
                            }
                            t1 = J.get$iterator$ax(ids), t2 = $async$self._usersCache, t3 = $async$self._retrieveUserCallback;
                        case 3:
                            // for condition
                            if (!t1.moveNext$0()) {
                                // goto after for
                            ...
                            t4 = t1.get$current();
                            $async$goto = t2.$index(0, t4) == null ? 5 : 6;
                            break;
                        case 5:
                            // then
                            $async$temp1 = t2;
                            $async$temp2 = t4;
                            $async$goto = 7;
                            return P._asyncAwait(t3.call$1(t4), $async$_getUsersFromIds$1);
                        case 7:
                            // returning from await.
                        ...
                        case 6:
                            ...
                            if (t2.$index(0, t4) != null)
                                C.JSArray_methods.add$1(users, t2.$index(0, t4));
                            // goto for condition
                            $async$goto = 3;
                            break;
                        case 4:
            ...
            return P._asyncStartSync($async$_getUsersFromIds$1, $async$completer);
        },
        connect$0: function () {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(P.bool),
                $async$returnValue, $async$self = this, t1, t2, localToForeignController, foreignToLocalController, t3,
                t4, t5, t6, t7, t8, t9, t10, t11, t12, success;
                ...
                while (true)
                    switch ($async$goto) {
                        case 0:
                            ...
                            t1 = W.WebSocket_WebSocket(P._Uri__Uri("api.dalk.io", "/v1/projects/" + H.S($async$self.projectId) + "/ws", null, 8080, "wss").toString$0(0), null);
                            ...
                            t7._server = new R.Server(new V.ChannelManager("Server", new R._StreamChannel(new P._ControllerStream(t3, [H.getTypeArgumentByIndex(t3, 0)]), t8, t9), new P._SyncCompleter(new P._Future($.Zone__current, t5), t6)), new H.JsLinkedHashMap([t1, t10]), t11, new G.DalkSdk_connect_closure($async$self));
                            ...
                            t1 = $async$self._peer;
                            t1.toString;
                            t2 = H.functionTypeCheck(new G.DalkSdk_connect_closure0($async$self), {
                                func: 1,
                                args: [S.Parameters]
                            });
                            t1 = t1._server._fallbacks;
                            t1._add$1(H.assertSubtypeOfRuntimeType(t2, H.getTypeArgumentByIndex(t1, 0)));
                            $async$self._connectAndReconnect$0();
                            t1 = $async$self._peer;
                            t2 = P.String;
                            t2 = P.LinkedHashMap_LinkedHashMap$_literal(["id", $async$self.me.id], t2, t2);
                            $async$goto = 3;
                            return P._asyncAwait(t1._client.sendRequest$2("registerUser", t2), $async$connect$0);
                        case 3:
                            // returning from await.
                            success = $async$result;
                            if (success == null)
                                success = false;
                            $async$self._logger.log$4(C.Level_INFO_800, "registerUser " + H.S(success), null, null);
                            H.boolTypeCheck(success);
                            $async$goto = success ? 4 : 6;
                            break;
                        case 4:
                            // then
                            $async$self._peer._server.registerMethod$2("onConversationCreated", new G.DalkSdk_connect_closure1($async$self));
                            $async$self._conversations.get$values().forEach$1(0, new G.DalkSdk_connect_closure2($async$self));
                            // goto join
                            $async$goto = 5;
                            break;
                        case 6:
                            // else
                            $async$self._shouldReconnect = false;
                            $async$goto = 7;
                            return P._asyncAwait($async$self._peer.close$0(0), $async$connect$0);
                        case 7:
                        // returning from await.
                        case 5:
                            // join
                            $async$returnValue = H.futureOrCheck(success, {futureOr: 1, type: P.bool});
                            // goto return
                            $async$goto = 1;
                            break;
                        case 1:
        ...
        _forwardMessageUpdate$1: function (parameters) {
            ...
            this._logger.log$4(C.Level_INFO_800, "updateMessageState " + H.S(parameters.get$value()), null, null);
            t1 = parameters.method;
            t1.toString;
            t1 = this._conversations.$index(0, H.stringReplaceAllUnchecked(t1, "updateMessageState", ""));
            if (t1 != null)
        ...
        _createConversationFromData$1: function (conv) {
            var $async$goto = 0,
                ...
                $async$returnValue, $async$self = this, t2, messages, t3, t4, t5, t6, t7, t8, conversation, t1;
                ...
                while (true)
                    switch ($async$goto) {
                        case 0:
                            ...
                            t2 = G.Message;
                            t1 = H.CastIterable_CastIterable(t1, H.getRuntimeTypeArgument(t1, "Iterable", 0), t2);
                            messages = P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "Iterable", 0));
                            t1 = H.stringTypeCheck(conv.$index(0, "id"));
                            t3 = H.stringTypeCheck(conv.$index(0, "subject"));
                            t4 = H.stringTypeCheck(conv.$index(0, "avatar"));
                            t5 = P.String;
                            t6 = [t5];
                            $async$goto = 3;
                            return P._asyncAwait($async$self._getUsersFromIds$1(H.assertSubtype(J.cast$1$0$ax(conv.$index(0, "users"), t5), "$isList", t6, "$asList")), $async$_createConversationFromData$1);
                        case 3:
                            // returning from await.
                            t7 = $async$result;
                            t8 = conv.$index(0, "admins");
                            $async$goto = 4;
                            return P._asyncAwait($async$self._getUsersFromIds$1(H.assertSubtype(t8 == null ? null : J.cast$1$0$ax(t8, t5), "$isList", t6, "$asList")), $async$_createConversationFromData$1);
                        case 4:
                            // returning from await.
                            t5 = $async$result;
                            t6 = $async$self._peer;
                            t8 = H.setRuntimeTypeInfo([], [G.User]);
                            t2 = P.StreamController_StreamController$broadcast(t2);
                            conversation = new G._ConversationImpl(t1, t3, t4, $async$self._logger, $async$self.me, t7, t8, messages, t2);
                            C.JSArray_methods.addAll$1(t8, t5);
                            conversation._peer = t6;
        ...
        createOneToOneConversation$body$DalkSdk: function (user, conversationId) {
            var $async$goto = 0,
                ...
                result, ex, stack, t1, t2, t3, t4, exception, $async$exception;
                ...
                while (true)
                    switch ($async$goto) {
                        case 0:
                            ...
                            $async$handler = 4;
                            t2 = $async$self._peer;
                            t3 = conversationId == null ? H.S($async$self.me.id) + H.S(t1) : conversationId;
                            t4 = P.String;
                            t4 = P.LinkedHashMap_LinkedHashMap$_literal(["id", t3, "users", H.setRuntimeTypeInfo([t1, $async$self.me.id], [t4])], t4, P.Object);
                            $async$goto = 7;
                            return P._asyncAwait(t2._client.sendRequest$2("getOrCreateConversation", t4), $async$createOneToOneConversation$2$conversationId);
                        case 7:
                            // returning from await.
                            result = $async$result;
        ...
        createGroupConversation$body$DalkSdk: function (users, avatar, conversationId, subject) {
            var $async$goto = 0,
                ...
                result, ex, stack, t2, t3, t4, t5, exception, $async$exception;
                ...
                while (true)
                    switch ($async$goto) {
                        case 0:
                            ...
                            t5 = conversationId == null ? t2.map$1$1(users, new G.DalkSdk_createGroupConversation_closure0(), t4).join$0(0) : conversationId;
                            J.$indexSet$ax(t1, "id", t5);
                            J.$indexSet$ax(t1, "users", t2.map$1$1(users, new G.DalkSdk_createGroupConversation_closure1(), t4).toList$0(0));
                            if (subject != null)
                                J.$indexSet$ax(t1, "subject", subject);
                            if (avatar != null)
                                J.$indexSet$ax(t1, "avatar", avatar);
        ...
        getConversations$0: function () {
            var $async$goto = 0,
                ...
                $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this,
                result, conversations, conv, conversation, ex, stack, exception, t2, t1, $async$exception;
                ...
                while (true)
                    switch ($async$goto) {
                        ...
                        case 7:
                            ...
                            conversations = H.setRuntimeTypeInfo([], [G.Conversation]);
                            t1 = J.get$iterator$ax(H.listSuperNativeTypeCheck(result, "$isIterable"));
                        case 8:
                            // for condition
                            if (!t1.moveNext$0()) {
                                // goto after for
                        ...
                        case 10:
                            ...
                            J.add$1$ax(conversations, conversation);
                            // goto for condition
                            $async$goto = 8;
                            break;
                        case 9:
                            // after for
                            $async$returnValue = conversations;
                            // goto return
                            $async$goto = 1;
                            break;
                            $async$handler = 2;
        ...
        getConversation$body$DalkSdk: function (conversationId) {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(G.Conversation),
                $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this,
                result, conv, ex, stack, t2, exception, t1, $async$exception;
                ...
                while (true)
                    switch ($async$goto) {
                        ...
                        case 7:
                            ...
                            $async$goto = t1.$index(0, conversationId) == null ? 8 : 10;
                            break;
                        case 8:
                            // then
                            $async$goto = 11;
    ...
    G.DalkSdk_connect_closure1.prototype = {
        call$1: function (parameters) {
            var $async$goto = 0,
    ...
    G.DalkSdk_connect_closure2.prototype = {
        call$1: function (conv) {
            var t1;
    ...
    G.__$MessageCopyWithImpl.prototype = {
        call$6$id$senderId$status$statusDetails$text$timestamp: function (id, senderId, $status, statusDetails, text, timestamp) {
            var _this = this,
                ...
                t5 = J.$eq$(timestamp, C.C_Freezed) ? H.interceptedTypeCast(_this._sdk_base$_value, "$is__Message").timestamp : H.interceptedTypeCast(timestamp, "$isDateTime"),
            ...
            return _this._then.call$1(t1.copyWith$6$id$senderId$status$statusDetails$text$timestamp(t2, t3, t6, J.$eq$(statusDetails, C.C_Freezed) ? H.interceptedTypeCast(_this._sdk_base$_value, "$is__Message").statusDetails : H.subtypeCast(statusDetails, "$isList", [G.UserMessageStatus], "$asList"), t4, t5));
        },
        call$0: function () {
            return this.call$6$id$senderId$status$statusDetails$text$timestamp(C.C_Freezed, C.C_Freezed, C.C_Freezed, C.C_Freezed, C.C_Freezed, C.C_Freezed);
        },
        call$1$status: function ($status) {
            return this.call$6$id$senderId$status$statusDetails$text$timestamp(C.C_Freezed, C.C_Freezed, $status, C.C_Freezed, C.C_Freezed, C.C_Freezed);
        }
    };
    G.__$_MessageCopyWithImpl.prototype = {
        call$6$id$senderId$status$statusDetails$text$timestamp: function (id, senderId, $status, statusDetails, text, timestamp) {
            var _this = this,
                ...
                t4 = J.$eq$(timestamp, C.C_Freezed) ? H.interceptedTypeCast(_this._sdk_base$_value, "$is__Message").timestamp : H.interceptedTypeCast(timestamp, "$isDateTime"),
    ...
    G._$__Message.prototype = {
        toString$0: function (_) {
            var _this = this;
            return "_Message._(id: " + H.S(_this.id) + ", senderId: " + H.S(_this.senderId) + ", text: " + H.S(_this.text) + ", timestamp: " + H.S(_this.timestamp) + ", status: " + H.S(_this.status) + ", statusDetails: " + H.S(_this.statusDetails) + ")";
        },
        $eq: function (_, other) {
            var t1, t2, _this = this;
            if (other == null)
        ...
        copyWith$6$id$senderId$status$statusDetails$text$timestamp: function (arg0, arg1, arg2, arg3, arg4, arg5) {
            return this.get$copyWith().call$6$id$senderId$status$statusDetails$text$timestamp(arg0, arg1, arg2, arg3, arg4, arg5);
        }
    };
    ...
    S.Parameter.prototype = {
        get$_path: function () {
            ...
            return H.stringTypeCheck(new S.Parameter__path_computePath(new S.Parameter__path_quoteKey()).call$1(this));
        },
        ...
        _getTyped$2: function (type, test) {
            var _this = this;
            if (H.boolConversionCheck(H.functionTypeCheck(test, {
                func: 1,
                ret: P.bool,
                args: [,]
            }).call$1(_this.get$value())))
    ...
    U.Peer.prototype = {
        ...
        close$0: function (_) {
            return P.Future_wait(H.setRuntimeTypeInfo([this._client._client$_manager.close$0(0), this._server._server$_manager.close$0(0), this._manager.close$0(0)], [[P.Future, ,]]), null);
        },
        $isClient: 1,
        $isServer: 1
    };
    ...
    R.Server.prototype = {
        ...
        _handleSingleRequest$body$Server: function (request) {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(null),
                $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this,
                $name, method, result, error, stackTrace, chain, t1, method0, t2, params, id, exception,
                $async$exception;
        ...
        _tryFallbacks$1: function (params) {
            var t1 = this._fallbacks,
                list = H.setRuntimeTypeInfo([], [H.getTypeArgumentByIndex(t1, 0)]);
            C.JSArray_methods.set$length(list, t1.get$length(t1));
            t1._writeToList$1(list);
            return new R.Server__tryFallbacks__tryNext(new J.ArrayIterator(list, list.length, [H.getTypeArgumentByIndex(list, 0)]), params).call$0();
        }
    };
    ...
    R.Server__tryFallbacks__tryNext.prototype = {
        $call$body$Server__tryFallbacks__tryNext: function () {
            var $async$goto = 0,
                $async$completer = P._makeAsyncAwaitCompleter(null),
                $async$returnValue, $async$next = [], $async$self = this, error, t1, exception, _tryNext;
                ...
                while (true)
                    switch ($async$goto) {
                        case 0:
                            ...
                            try {
                                t1 = _tryNext.iterator.current$1(_tryNext.params);
                                $async$returnValue = t1;
                                // goto return
                                $async$goto = 1;
                                break;
    ...
    B._RespondToFormatExceptionsTransformer.prototype = {
        bind$1: function (channel) {
            ...
            return t1.transformed = F.CloseGuaranteeChannel$(H.functionTypeCheck(new B._RespondToFormatExceptionsTransformer_bind_closure(t1), {
                func: 1,
                ret: [P.Stream, t2],
                args: [[P.Stream, t2]]
            }).call$1(channel.get$stream(channel)), channel.get$sink(), t2);
        },
    ...
    M.Context.prototype = {
        ...
        join$8: function (_, part1, part2, part3, part4, part5, part6, part7, part8) {
            ...
            return this.joinAll$1(new H.WhereIterable(parts, H.functionTypeCheck(new M.Context_join_closure(), {
                func: 1,
                ret: P.bool,
                args: [t1]
            }), [t1]));
        ...
        joinAll$1: function (parts) {
            ...
            for (t1 = H.getTypeArgumentByIndex(parts, 0), t2 = H.functionTypeCheck(new M.Context_joinAll_closure(), {
                func: 1,
                ret: P.bool,
                args: [t1]
            }), t3 = parts.get$iterator(parts), t1 = new H.WhereIterator(t3, t2, [t1]), t2 = this.style, needsSeparator = false, isAbsoluteAndNotRootRelative = false, t4 = ""; t1.moveNext$0();) {
                t5 = t3.get$current();
        ...
        split$1: function (_, path) {
            var parsed = X.ParsedPath_ParsedPath$parse(path, this.style),
                t1 = parsed.parts,
                t2 = H.getTypeArgumentByIndex(t1, 0);
            parsed.set$parts(P.List_List$from(new H.WhereIterable(t1, H.functionTypeCheck(new M.Context_split_closure(), {
                func: 1,
                ret: P.bool,
                args: [t2]
            }), [t2]), true, t2));
    ...
    L.WindowsStyle.prototype = {
        ...
        absolutePathToUri$1: function (path) {
            ...
            if (J.startsWith$1$s(t1, "\\\\")) {
                ...
                t2 = H.getTypeArgumentByIndex(t1, 0);
                rootParts = new H.WhereIterable(t1, H.functionTypeCheck(new L.WindowsStyle_absolutePathToUri_closure(), {
                    func: 1,
                    ret: P.bool,
                    args: [t2]
                }), [t2]);
    ...
    U.Chain.prototype = {
        toTrace$0: function () {
            var t1 = this.traces,
                t2 = A.Frame,
                t3 = H.getTypeArgumentByIndex(t1, 0);
            return new Y.Trace(P.List_List$unmodifiable(new H.ExpandIterable(t1, H.functionTypeCheck(new U.Chain_toTrace_closure(), {
                func: 1,
                ret: [P.Iterable, t2],
                args: [t3]
            }), [t3, t2]), t2), new P._StringStackTrace(null));
        },
        toString$0: function (_) {
            var t1 = this.traces,
                t2 = P.int,
                t3 = H.getTypeArgumentByIndex(t1, 0),
                t4 = P.String;
            return new H.MappedListIterable(t1, H.functionTypeCheck(new U.Chain_toString_closure(new H.MappedListIterable(t1, H.functionTypeCheck(new U.Chain_toString_closure0(), {
                func: 1,
                ret: t2,
                args: [t3]
            }), [t3, t2]).fold$1$2(0, 0, H.instantiate1(P.math__max$closure(), t2), t2)), {
                func: 1,
                ret: t4,
                args: [t3]
            }), [t3, t4]).join$1(0, "===== asynchronous gap ===========================\n");
        },
        $isStackTrace: 1,
        get$traces: function () {
            return this.traces;
    ...
    U.Chain_toString_closure0.prototype = {
        call$1: function (trace) {
            var t1 = H.interceptedTypeCheck(trace, "$isTrace").get$frames(),
                t2 = P.int,
                t3 = H.getTypeArgumentByIndex(t1, 0);
            return new H.MappedListIterable(t1, H.functionTypeCheck(new U.Chain_toString__closure0(), {
                func: 1,
                ret: t2,
                args: [t3]
            }), [t3, t2]).fold$1$2(0, 0, H.instantiate1(P.math__max$closure(), t2), t2);
    ...
    U.Chain_toString_closure.prototype = {
        call$1: function (trace) {
            var t1 = H.interceptedTypeCheck(trace, "$isTrace").get$frames(),
                t2 = P.String,
                t3 = H.getTypeArgumentByIndex(t1, 0);
            return new H.MappedListIterable(t1, H.functionTypeCheck(new U.Chain_toString__closure(this.longest), {
                func: 1,
                ret: t2,
                args: [t3]
            }), [t3, t2]).join$0(0);
    ...
    Y.Trace.prototype = {
        toString$0: function (_) {
            var t1 = this.frames,
                ...
                t3 = H.getTypeArgumentByIndex(t1, 0),
                t4 = P.String;
            return new H.MappedListIterable(t1, H.functionTypeCheck(new Y.Trace_toString_closure(new H.MappedListIterable(t1, H.functionTypeCheck(new Y.Trace_toString_closure0(), {
                func: 1,
                ret: t2,
                args: [t3]
            }), [t3, t2]).fold$1$2(0, 0, H.instantiate1(P.math__max$closure(), t2), t2)), {
    ...
    F.CloseGuaranteeChannel.prototype = {
        ...
        set$_stream: function (_stream) {
            this._stream = H.assertSubtype(_stream, "$is_CloseGuaranteeStream", this.$ti, "$as_CloseGuaranteeStream");
        },
    ...
    R.HtmlWebSocketChannel.prototype = {
        ...
        HtmlWebSocketChannel$1: function (_webSocket) {
            ...
            t2 = W.MessageEvent;
            W._EventStreamSubscription$(t1, "message", H.functionTypeCheck(new R.HtmlWebSocketChannel_closure1(_this), {
                func: 1,
                ret: -1,
                args: [t2]
            }), false, t2);
    ...
    (function installTearOffs() {
        ...
        _instance(P._Future.prototype, "get$_completeError", 0, 1, function () {
            return [null];
        }, ["call$2", "call$1"], ["_completeError$2", "_completeError$1"], 18, 0);
        _instance_1_i(_ = P._StreamController.prototype, "get$add", "add$1", 10);
        _instance(_, "get$addError", 0, 1, function () {
            return [null];
        }, ["call$2", "call$1"], ["addError$2", "addError$1"], 18, 0);
        ...
        _instance_2_u(_, "get$_async$_handleError", "_async$_handleError$2", 61);
        _instance_0_u(_, "get$_handleDone", "_handleDone$0", 1);
        _static_2(P, "collection___defaultEquals$closure", "_defaultEquals", 78);
        _static_1(P, "collection___defaultHashCode$closure", "_defaultHashCode", 79);
        ...
        _instance_1_u(_ = G.DalkSdk.prototype, "get$_forwardMessageUpdate", "_forwardMessageUpdate$1", 24);
        ...
        _instance_1_u(_ = R.Server.prototype, "get$_handleRequest", "_handleRequest$1", 21);
        _instance_1_u(_, "get$_handleSingleRequest", "_handleSingleRequest$1", 21);
        _instance_1_u(_, "get$_tryFallbacks", "_tryFallbacks$1", 57);
    ...
    (function inheritance() {
        ...
        _inheritMany(J.JavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, G.Promise, G._Exports]);
    ...
    var init = {
        ...
        metadata: [],
        types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: P.Null, args: [,]}, {
            func: 1,
            ret: P.bool,
            args: [P.String]
        }, {func: 1, args: [,]}, {func: 1, ret: -1, args: [,]}, {func: 1, ret: P.Null, args: [, ,]}, {
            func: 1,
            ret: A.Frame,
            args: [P.String]
        }, {func: 1, ret: P.Null, args: [{func: 1, ret: -1, args: [-1]}, P.Function]}, {
            func: 1,
            ret: A.Frame
        }, {func: 1, ret: -1, args: [P.Object]}, {func: 1, ret: P.bool, args: [G.Conversation]}, {
            func: 1,
            ret: P.bool,
            args: [G.Message]
        }, {func: 1, ret: [G.Promise, -2], args: [P.String, P.String]}, {
            func: 1,
            ret: -1,
            args: [{func: 1, ret: -1}]
        }, {func: 1, ret: P.bool, args: [,]}, {func: 1, ret: P.String, args: [P.String]}, {
            func: 1,
            ret: P.Null,
            args: [{func: 1, ret: -1, args: [P.Null]}, P.Function]
        }, {func: 1, ret: -1, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.int, args: [P.String]}, {
            func: 1,
            ret: P.Null,
            args: [P.String]
        }, {func: 1, ret: [P.Future, ,], args: [,]}, {func: 1, ret: P.Null, args: [, P.StackTrace]}, {
            func: 1,
            ret: G._Message,
            args: [,]
        }, {func: 1, ret: -1, args: [S.Parameters]}, {func: 1, ret: P.String, args: [G.User]}, {
            func: 1,
            ret: U.Chain
        }, {func: 1, ret: Y.Trace, args: [P.String]}, {func: 1, ret: P.int, args: [A.Frame]}, {
            func: 1,
            ret: P.String,
            args: [A.Frame]
        }, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: P.Uint8List, args: [P.int]}, {
            func: 1,
            ret: P.Null,
            args: [{func: 1, ret: -1, args: [P.bool]}, P.Function]
        }, {func: 1, ret: [G.Promise, -2]}, {
            func: 1,
            ret: P.Null,
            args: [{func: 1, ret: -1, args: [[P.List, ,]]}, P.Function]
        }, {func: 1, ret: P.Null, args: [[P.List, G.Conversation]]}, {
            func: 1,
            ret: [G.Promise, -2],
            args: [P.String]
        }, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {
            func: 1,
            ret: [G.Promise, -2],
            args: [G.User, P.String]
        }, {func: 1, ret: [G.Promise, -2], args: [[P.List, G.User], P.String, P.String, P.String]}, {
            func: 1,
            ret: [G.Promise, -2]
        }, {func: 1, ret: P.Null, args: [P.String, ,]}, {func: 1, ret: -1, args: [P.String, P.int]}, {
            func: 1,
            ret: -1,
            args: [P.String],
            opt: [,]
            ...
            ret: [G.Promise, -2],
            args: [P.String, P.String, P.String]
        }, {func: 1, ret: G.User, args: [, , ,]}, {func: 1, ret: G.UserMessageStatus, args: [,]}, {
            func: 1,
            ret: P.Null,
            args: [P.int, ,]
        }, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, args: [, P.String]}, {
            func: 1,
            ret: P.Null,
            args: [S.Parameters]
        }, {func: 1, ret: [P.Future, P.Null], args: [,]}, {func: 1, ret: P.Null, args: [G.Conversation]}, {
            func: 1,
            ret: G.User,
            args: [G.User]
        }, {func: 1, ret: P.Null, args: [P.Symbol0, ,]}, {func: 1, bounds: [P.num], ret: 0, args: [0, 0]}, {
            func: 1,
            ret: [P.Future, ,],
            args: [S.Parameters]
        }, {func: 1, ret: [P.Future, ,]}, {func: 1, bounds: [P.Object], ret: 0, args: [0]}, {
            func: 1,
            ret: F.Logger
        }, {func: 1, ret: -1, args: [, P.StackTrace]}, {func: 1, ret: P.String, args: [P.int]}, {
            func: 1,
            ret: P.Uint8List,
            args: [, ,]
        }, {func: 1, args: [W.Event]}, {func: 1, ret: [P.List, A.Frame], args: [Y.Trace]}, {
            func: 1,
            ret: P.int,
            args: [Y.Trace]
        }, {func: 1, args: [P.String]}, {func: 1, ret: P.String, args: [Y.Trace]}, {
            func: 1,
            ret: G.DalkSdk,
            args: [, ,]
        }, {func: 1, args: [, ,]}, {func: 1, ret: A.Frame, args: [, ,]}, {
            func: 1,
            ret: P.Null,
            args: [,],
            opt: [P.StackTrace]
        }, {func: 1, ret: P.Null, args: [P.Object, [P.EventSink, P.String]]}, {
            func: 1,
            ret: G.User,
            args: [P.String]
        }, {func: 1, ret: P.Null, args: [W.MessageEvent]}, {func: 1, ret: P.Null, args: [W.CloseEvent]}, {
            func: 1,
            ret: [G.Promise, -2]
        }, {func: 1, ret: P.bool, args: [, ,]}, {func: 1, ret: P.int, args: [,]}, {
            func: 1,
            args: [P.String],
            named: {reviver: {func: 1, ret: P.Object, args: [P.Object, P.Object]}}
        }, {func: 1, ret: P.int, args: [P.Object]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {
            func: 1,
            ret: [P.Stream, ,],
            args: [[P.Stream, ,]]
        }, {func: 1, ret: [P._Future, ,], args: [,]}],
    ...
    (function constants() {
        ...
        C.MessageStatus_0 = new G.MessageStatus(0, "MessageStatus.sent");
        C.MessageStatus_1 = new G.MessageStatus(1, "MessageStatus.received");
        C.MessageStatus_2 = new G.MessageStatus(2, "MessageStatus.seen");
        C.MessageStatus_3 = new G.MessageStatus(3, "MessageStatus.ongoing");
        C.List_AYZ = H.setRuntimeTypeInfo(makeConstList([C.MessageStatus_0, C.MessageStatus_1, C.MessageStatus_2, C.MessageStatus_3]), [G.MessageStatus]);
    ...
    (function nativeSupport() {
        ...
        hunkHelpers.setOrUpdateInterceptorsByTag({
            ...
            WindowClient: J.Interceptor,
            SQLError: J.Interceptor,
            ArrayBuffer: H.NativeByteBuffer,
            ...
            Event: W.Event,
            InputEvent: W.Event,
            MessagePort: W.EventTarget,
            ServiceWorker: W.EventTarget,
